...
$query = "SELECT * FROM ruang_perawatan WHERE id_ruang = '$id_ruang'";
$result = mysqli_query($koneksi, $query);
if ($result && mysqli_num_rows($result) > 0) {
...
$tanggal_temu = date('Y-m-d H:i:s'); // Assuming this is the appointment date and time
?>
                    ...
                    <div class="mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Ruang:</strong> <?php echo $room['nama_ruang']; ?></p>
                                <p><strong>Jenis Ruang:</strong> <?php echo $room['jenis_ruang']; ?></p>
                                <p><strong>Biaya:</strong> <?php echo 'Biaya akan tersedia kalau pasien keluar atau checkout dari kamar'; ?></p>
                            </div>
                            <div class="card-body">
