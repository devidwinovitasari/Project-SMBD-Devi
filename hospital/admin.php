            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Menambah dan mengubah data disini.</li>
                    </ol>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title"><a href="rawatinap.php">Pendaftaran rawat inap</a></h4>
                                            <p class="card-text">Silahkan Mendaftar...</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            <div class="icon mb-3"><i class="bx bx-trophy" style="font-size: 2rem;"></i></div>
                                            <h4 class="card-title"><a href="operasi.php">Pendaftaran Operasi</a></h4>
                                            <p class="card-text">Silahkan Mendaftar...</p>
                                        </div>
                                    </div>
                                </div>
