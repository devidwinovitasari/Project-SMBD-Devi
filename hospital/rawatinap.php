        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            echo "<script>
                    if (confirm('Data pasien dengan NIK ini sudah ada. Lanjutkan dengan data yang ada?')) {
                        window.location.href = 'processrawatinap.php?nik=$nik&poli=$poli';
                    } else {
                        window.location.href = 'rawatinap.php'; // Redirect to another page or home
                    }
                    </script>";
            ...
            if ($result_insert) {
                ...
                header("Location: processrawatinap.php?nik=$nik&poli=$poli");
                exit();
            } else {
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Pendaftaran pasien rawat inap.</li>
                    </ol>
                    <div class="mx-auto">
                        <div class="card">
