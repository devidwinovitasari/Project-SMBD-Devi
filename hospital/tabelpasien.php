...
if ($op == 'delete' && isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql1 = "DELETE FROM pasien WHERE id_pasien = ?";
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Untuk mengecek data pasien.</li>
                    </ol>
                    <div class="mx-auto">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql2 = "SELECT * FROM view_pasien ORDER BY id_pasien ASC";
                                        ...
                                        if ($q2) {
                                            while ($r2 = mysqli_fetch_array($q2)) {
                                                ...
                                                $jumlah_rawat_inap = $r2['jumlah_rawat_inap'];
                                                $jumlah_rawat_jalan = $r2['jumlah_rawat_jalan'];
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $tanggal_lahir ?></td>
                                                    <td><?= $jenis_kelamin ?></td>
                                                    <td><?= $jumlah_rawat_inap ?></td>
                                                    <td><?= $jumlah_rawat_jalan ?></td>
                                                    <td>
                                                        <a href="updatepasien.php?op=edit&id=<?= $id_pasien ?>"><button type="button" class="btn btn-warning">Ubah</button></a>
                                                        <a href="tabelpasien.php?op=delete&id=<?= $id_pasien ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
