...
if ($op == 'delete' && isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql1 = "DELETE FROM rawat_jalan WHERE id_rawat_jalan = ?";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Rawat Jalan</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Untuk mengecek data rawat jalan.</li>
                    </ol>
                    <div class="mx-auto">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql2 = "SELECT * FROM view_rawat_jalan ORDER BY id_rawat_jalan ASC";
                                        $q2 = mysqli_query($koneksi, $sql2);
                                        $urut = 1;
                                        if ($q2) {
                                            while ($r2 = mysqli_fetch_array($q2)) {
                                                $id = $r2['id_rawat_jalan'];
                                                $nama_pasien = $r2['nama_pasien'];
                                                $nama_dokter = $r2['nama_dokter'];
                                                $diagnosa = $r2['diagnosa'];
                                                $tanggal_periksa = $r2['tanggal_periksa'];
                                                $biaya_periksa = $r2['biaya_periksa'];
                                        ?>
                                                <tr>
                                                    <td><?= $urut++ ?></td>
                                                    <td><?= $nama_pasien ?></td>
                                                    ...
                                                    <td><?= $biaya_periksa ?></td>
                                                    <td>
                                                        <a href="updaterawatjalan.php?op=edit&id=<?= $id ?>"><button type="button" class="btn btn-warning">Ubah</button></a>
                                                        <a href="tabelrawatjalan.php?op=delete&id=<?= $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
